...
class SemanticParagraphMemory():
    ...
    def generate_keywords(self, question):
        ...
        keyword_agent = Agent("Generate search query keywords for the question provided by the user. These keywords will be matched against a memory of paragraphs that are annoted with keywords. Answer by return a comma separated list of keywords.", prompt_template="{question}", functions=[])
